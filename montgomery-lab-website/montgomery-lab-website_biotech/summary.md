...
- **Page-varied carousel queues:** carousel image order now includes page and position offsets, reducing repeated photo sequences across subpages that share the same starting image.
