...
export const metalContent = {
  ...
  consortia: [
    { id: "gregor", shortName: "GREGoR", name: "Genomics Research to Elucidate the Genetics of Rare Disease", href: "consortia/gregor.html", role: "Principal Investigator", focus: "Rare disease diagnosis and multi-omic interpretation for unsolved clinical cases.", logo: "assets/consortium_logos/gregor1.png", summary: "Rare disease diagnosis supported by multi-omic interpretation and functional consequence mapping.", output: "Clinical mechanism and molecular interpretation", roleDetail: "The Montgomery Lab contributes functional interpretation, molecular phenotyping, and rare-disease genomics expertise to the GREGoR ecosystem.", overview: "This consortium is centered on moving beyond sequence alone by connecting rare variants to transcriptomic and molecular consequences that can sharpen diagnosis.", labContribution: "Within the broader program, the lab's work fits naturally into multi-omic interpretation, outlier detection, and the translation of genomic findings into mechanism.", highlights: ["Rare disease diagnosis informed by functional genomics", "Integration of genomic, transcriptomic, and molecular data", "Clinical interpretation for unresolved cases"] },
    { id: "motrpac", shortName: "MoTrPAC", name: "Molecular Transducers of Physical Activity Consortium", href: "consortia/motrpac.html", role: "Principal Investigator", focus: "Body-wide molecular responses to exercise training across tissues and assays.", logo: "assets/consortium_logos/motrpac.png", summary: "Body-wide molecular responses to exercise training across tissues, assays, and training states.", output: "Exercise multi-omics and public portal outputs", roleDetail: "The Montgomery Lab participates in one of the highest-profile recent efforts to connect exercise physiology with multi-omic measurement at scale.", overview: "MoTrPAC brings together transcriptomic, proteomic, metabolomic, and related measurements to understand how physical activity drives coordinated biological change.", labContribution: "For the lab, this consortium extends core strengths in high-dimensional molecular data analysis into exercise-responsive biology and cross-tissue interpretation.", highlights: ["Large-scale molecular atlas of exercise adaptation", "Cross-tissue, cross-assay biology", "Strong overlap between consortium science and the lab's recent research momentum"] },
    { id: "topmed", shortName: "TOPMed", name: "Trans-Omics for Precision Medicine", href: "consortia/topmed.html", role: "Principal Investigator", focus: "Large-scale genomic and omic integration for human disease and population studies.", logo: "assets/consortium_logos/TOPMed.png", summary: "Population-scale genomics and precision medicine infrastructure.", output: "Large cohort interpretation and translational context", roleDetail: "The lab's participation aligns with long-standing interests in how variation, ancestry, and molecular phenotypes interact across human populations.", overview: "TOPMed is built around population-scale genomic data and its integration with downstream phenotypes, making it a natural home for quantitative genomics work.", labContribution: "The consortium complements the lab's work on gene regulation, ancestry-aware interpretation, and high-throughput analysis of human genetic effects.", highlights: ["Population-scale precision medicine", "Integration of genomic and molecular data", "Human disease and trait interpretation at scale"] },
    { id: "functional-adsp", shortName: "Functional ADSP", name: "Functional Alzheimer's Disease Sequencing Project", href: "consortia/functional-adsp.html", role: "Principal Investigator", focus: "Functional follow-up for neurodegenerative disease genetics.", logo: "assets/consortium_logos/fungen.png", summary: "Alzheimer's disease genetics interpreted through functional genomic systems.", output: "Disease-focused functional genomics", roleDetail: "The Montgomery Lab's consortium role supports molecular follow-up for neurodegenerative disease signals and variant interpretation.", overview: "This program connects Alzheimer's-associated variation to functional consequences that can be studied through expression, regulation, and related molecular readouts.", labContribution: "The lab's strengths in transcriptome genetics and rare-variant interpretation make it a strong fit for translating sequencing findings into biological mechanism.", highlights: ["Neurodegenerative disease genetics", "Functional follow-up after sequencing discovery", "Molecular interpretation of risk-associated variation"] },
    { id: "dgtex", shortName: "dGTEx", name: "Developmental GTEx", href: "consortia/dgtex.html", role: "Investigator", focus: "Developmental tissue context for regulatory effects.", logo: "assets/consortium_logos/dGTEx.png", summary: "Developmental tissue regulation and expression programs across human biology.", output: "Developmental regulation and tissue context", roleDetail: "This work expands familiar GTEx questions into developmental windows that are essential for understanding regulatory effects and disease origins.", overview: "By studying developmental tissues, dGTEx helps explain when and where regulatory effects emerge, and how timing shapes biological consequence.", labContribution: "The consortium fits the lab's broader interest in tissue-specific regulation, expression, and how human variation acts in specific biological contexts.", highlights: ["Developmental context for regulatory effects", "Extension of GTEx-style thinking into earlier biology", "Tissue-aware interpretation of genomic variation"] },
    { id: "igvf", shortName: "IGVF", name: "Impact of Genomic Variation on Function", href: "consortia/igvf.html", role: "Investigator", focus: "Functional interpretation of variation across assays and cell systems.", logo: "assets/consortium_logos/iGVF.png", summary: "Interpretable maps linking genomic variants to function.", output: "Variant-to-function reference maps", roleDetail: "The lab's role in IGVF aligns directly with its central scientific question: how genetic variation reshapes molecular function.", overview: "The consortium develops shared frameworks and datasets for moving from variant catalogues to experimentally and computationally grounded interpretation.", labContribution: "This work intersects with the lab's interest in regulation, splicing, molecular outliers, and systematic functional genomics.", highlights: ["Variant-to-function interpretation", "Cross-assay functional genomics", "Shared infrastructure for genomic effect mapping"] },
    { id: "smaht", shortName: "SMaHT", name: "Somatic Mosaicism across Human Tissues", href: "consortia/smaht.html", role: "Investigator", focus: "Mosaic variation and tissue-specific genomics.", logo: "assets/consortium_logos/SMaHT.png", summary: "Cell atlas and molecular reference generation at systems scale.", output: "Reference atlases and molecular standards", roleDetail: "The consortium complements the lab's broader interest in tissue-specific genomics and complex patterns of genetic variation across the body.", overview: "Somatic mosaicism raises questions that are both technical and biological, requiring careful measurement, tissue context, and integrative interpretation.", labContribution: "The lab's quantitative and molecular expertise supports the interpretation of mosaic variation in relation to expression, regulation, and tissue identity.", highlights: ["Somatic mosaicism across tissues", "Tissue-specific genomics", "Integration of complex variation with molecular phenotypes"] },
    { id: "all-of-us", shortName: "All of Us", name: "All of Us Research Program", href: "consortia/all-of-us.html", role: "Investigator", focus: "Population-scale precision medicine resources.", logo: "assets/consortium_logos/AoU.png", summary: "Population-scale precision medicine and representation-aware genomics.", output: "Representation-aware precision medicine resources", roleDetail: "Participation in All of Us reinforces the lab's interest in broad, diverse genomic resources and the interpretation of variation across populations.", overview: "The program aims to support a new generation of precision medicine studies by combining scale, diversity, and longitudinal health information.", labContribution: "For the lab, the program connects directly to questions around ancestry, regulation, molecular phenotypes, and the value of large reference resources.", highlights: ["Large-scale precision medicine resource", "Population diversity and representation", "Long-term value for genomic discovery and interpretation"] },
    { id: "udn", shortName: "UDN", name: "Undiagnosed Diseases Network", href: "consortia/udn.html", role: "Investigator", focus: "Hard clinical cases that need deeper molecular interpretation.", logo: "assets/consortium_logos/UDN.png", summary: "Mechanism-first support for unresolved clinical cases.", output: "Case resolution and translational genomics", roleDetail: "The lab's work in molecular interpretation and functional follow-up fits naturally into the needs of the Undiagnosed Diseases Network.", overview: "UDN brings together clinicians, genomic investigators, and functional scientists to solve difficult cases that demand deeper biological context.", labContribution: "The lab contributes approaches that connect rare variants to expression, molecular consequence, and disease-relevant mechanism.", highlights: ["Difficult-to-solve clinical cases", "Functional genomics for diagnosis", "Close link between sequencing results and biological mechanism"] },
    { id: "encode4", shortName: "ENCODE4", name: "ENCODE4", href: "consortia/encode4.html", role: "Investigator", focus: "Reference regulatory maps and functional annotation.", logo: "assets/consortium_logos/encode2.png", summary: "Reference functional genomics resources that shape interpretation workflows.", output: "Shared reference biology for downstream analysis", roleDetail: "Participation in ENCODE4 reflects the lab's investment in functional annotation, regulatory biology, and shared genomic infrastructure.", overview: "Reference maps of regulatory activity remain essential for interpreting how variants alter function, especially outside coding sequence.", labContribution: "The lab's research on gene regulation, expression, and the molecular impact of variation is tightly aligned with ENCODE's broader goals.", highlights: ["Reference regulatory annotation", "Functional maps for variant interpretation", "Shared infrastructure for modern genomics"] },
  ],
  resources: {
    intro:
