...
The initial integration statuses below are preserved as the historical package-audit decision. They are not a permanent freeze. `living_peer_universe_review.csv` subsequently applies one pay-blind admission rule across old and new source-validated observations. Center for Election Science (Tier C), Foresight Institute (Tier B), Leverage Research (Tier C), and Magnify Mentoring (Tier C) now enter the living default. Qualia Research Institute remains observed-only because its filing reports 15 hours per week. GiveWell and Copenhagen Consensus Center, recovered through the screened-109 follow-up, also enter the living default at Tier B and Tier C respectively. Scale, structure, evidence-form, and missing-staff differences remain explicit metadata and optional weights rather than duplicate exclusion criteria. The living methodology and validator reconcile the current 122-incumbent cash default and 114-row Schedule J base subset without changing this audit's frozen evidence findings.
...
| Leverage Research | Geoffrey Taylor Anders II, CEO/Chair/Treasurer: $21,533 Part VII cash; no Schedule J; **40 reported weekly hours** | $392,590 revenue; $430,580 expenses; **3 staff** (bundle omitted staff) | Initial observed-only decision, superseded for app inclusion by the pay-blind living review: micro-scale and the combined CEO/chair/treasurer structure are represented by Tier C and optional weighting |
| Qualia Research Institute | Andres Gomez Emilsson, President/Executive Director: $64,164 Part VII cash; no Schedule J; **15 reported weekly hours** | $140,681 revenue; $291,314 expenses; 4 staff | Observed only because the filing reports a part-time role |
