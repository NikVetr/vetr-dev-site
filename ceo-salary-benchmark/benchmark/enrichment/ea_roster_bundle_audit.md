...
| Leverage Research | Geoffrey Taylor Anders II, CEO/Chair/Treasurer: $21,533 Part VII cash; no Schedule J | $392,590 revenue; $430,580 expenses; **3 staff** (bundle omitted staff) | Observed only because the amount may reflect limited hours or an unusual leadership structure |
| Qualia Research Institute | Andres Gomez Emilsson, President/Executive Director: $64,164 Part VII cash; no Schedule J | $140,681 revenue; $291,314 expenses; 4 staff | Sensitivity only; another officer was paid more |

All four use the same verified 2024 annual-average CPI-U factor as the existing app (`1.0644880037701905`) for July 2026 dollars. `scripts/validate_ea_roster_additions.py` fails if any preserved filing value, arithmetic identity, staff count, or CPI factor diverges from `ea_roster_validated_compensation.csv`.

Three other EINs identify the named organizations, but their bundle scale fields are not accompanied by row-level source or transformation provenance. Animal Advocacy Africa's $227,000 expense claim differs from the latest filing's $173,506. Magnify Mentoring's $133,624.90 is not a reported filing value; it appears consistent with inflation-adjusting the available FY2025 expense of $131,684, but the package does not document that transformation (FY2024 expenses were $94,276). Probably Good's first available FY2024 Form 990-EZ reports $1,000,000 revenue and $0 expenses, while the bundle leaves its finance fields blank. These records remain screening-only.
