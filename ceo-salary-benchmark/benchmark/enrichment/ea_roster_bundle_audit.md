...
Three other EINs identify the named organizations, but their bundle scale claims are not validated: Animal Advocacy Africa's $227,000 expense claim conflicts with the latest filing's $173,506; Magnify Mentoring's $133,624.90 conflicts with the available $94,276 (FY2024) and $131,684 (FY2025); and Probably Good has no full filing supplying the claimed fields. These records remain screening-only.
